...
using PPCLI.PowerShell.Predictor.Services;
using System.Management.Automation.Subsystem.Prediction;

namespace PPCLI.PowerShell.Predictor
{
    public class PPCLIPowerShellPredictor : ICommandPredictor
    {
        ...
        internal PPCLIPowerShellPredictor(string guid)
        {
            _guid = new Guid(guid);
            _PPCLIPowerShellPredictorService = new PPCLIPowerShellPredictorService();
        ...
        {
            var result = _PPCLIPowerShellPredictorService.GetSuggestions(context);
